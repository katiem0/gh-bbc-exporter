...
func TestUploadArchiveToGitHub(t *testing.T) {
	...
	_ = os.Setenv("GH_TARGET_PAT", "test-token")
	defer func() { _ = os.Unsetenv("GH_TARGET_PAT") }()
...
func TestUploadLargeFileForceMultipart(t *testing.T) {
	...
	_ = os.Setenv("GH_TARGET_PAT", "invalid-token-for-test")
	defer func() { _ = os.Unsetenv("GH_TARGET_PAT") }()
...
func TestUploadWithMissingToken(t *testing.T) {
	...
	originalToken := os.Getenv("GH_TARGET_PAT")
	defer func() { _ = os.Unsetenv("GH_TARGET_PAT") }()
	defer func() {
		if originalToken != "" {
			_ = os.Setenv("GH_TARGET_PAT", originalToken)
		}
	}()
